...
function Project({ title, description, tags, imageUrl }) {
    ...
    return (
        <motion.div style={{
            ...
            <section
                className=' bg-gray-100 max-w-[42rem] border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem]  hover:bg-gray-200 transition group-even:pl-10'>
        ...
        group-even:right-[initial] group-even:-left-40'
                    ...
                    src={imageUrl} alt={'Projects i worked on'} quality={90} />
